...
public interface S3ControllerSpecification {
    ...
    @Operation(summary = "S3 단일 이미지 PresignedUrl 발급", description = "domain에 해당하는 S3 단일 이미지의 PresignedUrl을 발급합니다.")
    ...
    @Operation(summary = "S3 복수 이미지 PresignedUrl 발급", description = "domain에 해당하는 S3 복수 이미지의 PresignedUrl을 발급합니다.")
    @ApiResponse(responseCode = "COMMON200", description = "발급성공")
    @PostMapping("/presigned-urls")
    CustomResponse<List<Map<String, String>>> getPresignedUrls(
